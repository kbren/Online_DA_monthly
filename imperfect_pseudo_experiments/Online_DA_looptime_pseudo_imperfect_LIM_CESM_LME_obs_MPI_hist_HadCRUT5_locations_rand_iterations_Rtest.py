...
#        Xb = Xa
    ...
    savename = ('ODA_imperfect_pseudo_prior_'+modname+'_LIM_'+limname+'_obs_'+obsname+'_hadCRUT_locations_rand'+
                str(Nobs)+'_noise2_t_0_'+str(t_total)+'_nomj_trainR1_fixedmn2_it'+str(it)+'.pkl')
