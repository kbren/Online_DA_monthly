...
#                                          had_obs_data_full.shape[1]))
    ...
    Pa_diag_intime = np.zeros((t_total,neofs))
...
#         Pb = Pb*inflation
#         print('inflating covariance by '+str(inf))
    ...
    #    K_den_alltime[t] = K_den
        ...
        Pa_diag_intime[t,:] = np.diagonal(Pb)
...
#        Pb = Pa
    ...
    experiment['Pb_diagonal'] = Pa_diag_intime
...
#     savename = ('ODA_prior_'+modname+'_LIM_'+limname+'_obs_'+obsname+'_rand'+
#                 str(Nobs)+'_t_0_'+str(t_total)+'_nomj_trainR1_Pbsicinf'+str(inf)+'_it'+str(it)+'.pkl')
    savename = ('ODA_prior_'+modname+'_LIM_'+limname+'_obs_'+obsname+'_rand'+
                str(Nobs)+'_t_0_'+str(t_total)+'_nomj_trainR1_it'+str(it)+'.pkl')
