...
#    Pa_inf = Pa*1.5
    ...
    Pb = LIM_Xfcast['cov_forecast']*inflation
...
savename = ('ODA_prior_'+modname+'_LIM_'+limname+'_obs_'+obsname+'_hadCRUT_locations_rand'+str(Nobs)+
            '_inf'+inf_fact+'_t_0_'+str(t_total)+'_nomj_trainRe_it'+str(it)+'.pkl')
saveloc = '/home/disk/kalman2/mkb22/Online_DA/experiments/hadcrut/'
